...
public class Adjacency {
     ...
     *
     * @param source the index buffer of a normal GL_TRIANGLES mesh. Neither the position nor the limit are modified by
     *               this method
     * @param dest   will hold the indices of the triangles with adjacency information. It must have at least double the
